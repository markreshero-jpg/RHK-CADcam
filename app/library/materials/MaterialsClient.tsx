...
const TABS: TabConfig[] = [
  ...
  },
  {
    ...
    defaults: { name: '', brand: null, side_deduction: 25, min_runner_depth: 250, max_runner_depth: 550, soft_close: true, full_extension: true, cost_per_pair: null, active: true },
    fields: [
      { key: 'name',             label: 'Name',     type: 'text',    w: 160 },
      { key: 'brand',            label: 'Brand',    type: 'text',    w: 100 },
