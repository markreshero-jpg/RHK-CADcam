...
export default function NewProjectPage() {
  ...
  const inputCls =
    'w-full bg-gray-800 border border-gray-700 rounded px-3 py-2 text-sm text-white placeholder-gray-600 focus:outline-none focus:border-blue-500 transition-colors'
  ...
  return (
    <div className="min-h-screen bg-gray-950 text-gray-100 flex items-center justify-center p-6">
      <div className="w-full max-w-lg">
        ...
        <div className="mb-8">
          <Link href="/" className="text-xs text-gray-500 hover:text-gray-300 mb-4 block">← Projects</Link>
          <h1 className="text-2xl font-bold text-white tracking-tight">New Project</h1>
          <p className="text-gray-400 text-sm mt-1">Walls are drawn on the canvas after creation.</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div className="bg-gray-900 border border-gray-800 rounded-lg p-5 space-y-4">
            <div className="flex items-center justify-between">
              ...
              <span className="text-xs text-blue-400 bg-blue-400/10 px-2 py-0.5 rounded">CRM link pending</span>
            </div>
            <div>
            ...
            <div>
              <label className="block text-xs text-gray-400 mb-1.5">Project Address</label>
          ...
          <div className="bg-gray-900 border border-gray-800 rounded-lg p-5 space-y-4">
            <h2 className="text-sm font-semibold text-gray-300 uppercase tracking-wider">Project</h2>
            <div>
          ...
          <div className="bg-gray-900 border border-gray-800 rounded-lg p-5 space-y-4">
            <h2 className="text-sm font-semibold text-gray-300 uppercase tracking-wider">First Room</h2>
            <div className="grid grid-cols-2 gap-3">
              ...
              <div>
                <label className="block text-xs text-gray-400 mb-1.5">Ceiling Height (mm)</label>
            ...
            <p className="text-xs text-gray-600">Draw walls on the canvas after creating the project.</p>
          </div>
          ...
          <button type="submit" disabled={loading || !form.name.trim()}
            className="w-full bg-blue-600 hover:bg-blue-500 disabled:bg-gray-700 disabled:text-gray-500 text-white font-semibold py-3 rounded-lg transition-colors text-sm">
